...
class AlicatFlowController:
    ...
    def main(self):#, address, driver_version=1):
#        self.address = address
#        self.flow_controller = alicat.FlowController(self.port, self.address, driver_version)
...
if __name__ == '__main__':
    ...
    parser.add_option("--driver_version", type="int", dest="driver_version", default=2,
